...
@Component({
  selector: 'mdtx-price-level-toolbar',
  standalone: true,
  imports: [ToolbarComponent, InputSearchComponent],
  templateUrl: './price-level-toolbar.component.html',
  styleUrl: './price-level-toolbar.component.scss',
})
export class PriceLevelToolbarComponent {
