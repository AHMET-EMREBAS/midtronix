...
@Component({
  selector: 'mdtx-customer-account-toolbar',
  standalone: true,
  imports: [ToolbarComponent, InputSearchComponent],
  templateUrl: './customer-account-toolbar.component.html',
  styleUrl: './customer-account-toolbar.component.scss',
})
export class CustomerAccountToolbarComponent {
