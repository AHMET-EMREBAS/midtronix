...
import {
  SKU_VIEW_VIEW_COLUMNS,
  SKU_VIEW_VIEW_DISPLAY_COLUMNS,
  SKU_VIEW_VIEW_PAGE_SIZE,
  PAGE_SIZE_OPTIONS,
} from '../../table-options';
...
export class SkuViewViewTableComponent extends BaseTableComponent<ISkuViewViewRaw> {
  ...
  override pageSize = SKU_VIEW_VIEW_PAGE_SIZE;
  override columns = SKU_VIEW_VIEW_COLUMNS;
  override displayedColumns = SKU_VIEW_VIEW_DISPLAY_COLUMNS;
