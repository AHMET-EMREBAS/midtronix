...
const meta: Meta<PriceLevelTableComponent> = {
  component: PriceLevelTableComponent,
  title: 'PriceLevelTableComponent',
...
export default meta;
type Story = StoryObj<PriceLevelTableComponent>;
...
export const Heading: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // expect(canvas.getByText(/price-level-table works!/gi)).toBeTruthy();
  },
};
