...
const meta: Meta<QuantityTableComponent> = {
  component: QuantityTableComponent,
  title: 'QuantityTableComponent',
...
export default meta;
type Story = StoryObj<QuantityTableComponent>;
...
export const Heading: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    // expect(canvas.getByText(/quantity-table works!/gi)).toBeTruthy();
  },
};
