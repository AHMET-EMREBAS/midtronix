...
import { ProductViewService } from '@mdtx/modules/ngrx';
import { InputAutocompleteComponent } from '@mdtx/material/form';
import { BaseSearchComponent } from '@mdtx/material/core';

@Component({
  selector: 'mdtx-product-view-search',
  standalone: true,
  ...
  template: `
    ...
    <mdtx-input-autocomplete
      ...
      *ngIf="options$ | async as options"
      ...
      inputName="productView"
      label="Search ProductView"
      prefixIcon="search"
...
export class ProductViewSearchComponent extends BaseSearchComponent<IProductView> {}
