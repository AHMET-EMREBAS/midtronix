...
import { CustomerViewService } from '@mdtx/modules/ngrx';
import { InputAutocompleteComponent } from '@mdtx/material/form';
import { BaseSearchComponent } from '@mdtx/material/core';

@Component({
  selector: 'mdtx-customer-view-search',
  standalone: true,
  ...
  template: `
    ...
    <mdtx-input-autocomplete
      ...
      *ngIf="options$ | async as options"
      ...
      inputName="customerView"
      label="Search CustomerView"
      prefixIcon="search"
...
export class CustomerViewSearchComponent extends BaseSearchComponent<ICustomerView> {}
