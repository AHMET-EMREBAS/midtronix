...
import { OrderViewService } from '@mdtx/modules/ngrx';
import { InputAutocompleteComponent } from '@mdtx/material/form';
import { BaseSearchComponent } from '@mdtx/material/core';

@Component({
  selector: 'mdtx-order-view-search',
  standalone: true,
...
export class OrderViewSearchComponent extends BaseSearchComponent<IOrderView> {}
