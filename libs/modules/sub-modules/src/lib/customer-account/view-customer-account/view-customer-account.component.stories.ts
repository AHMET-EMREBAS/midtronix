...
const meta: Meta<ViewCustomerAccountComponent> = {
  component: ViewCustomerAccountComponent,
  title: 'ViewCustomerAccountComponent',
  decorators: [
    applicationConfig({
      providers: [
...
export default meta;
type Story = StoryObj<ViewCustomerAccountComponent>;
