...
export class ProductImageSearchComponent {
  ...
  @Input() inputControl = new FormControl<IProductImage | null>(null, []);
  @Input() defaultValue?: IProductImage;
  @Output() changeEvent = new EventEmitter<IProductImage>();

  search$ = new BehaviorSubject<string>('');

  options$: Observable<IProductImage[]> = this.service.entities$;
