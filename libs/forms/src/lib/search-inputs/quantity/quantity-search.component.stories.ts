...
import { QuantitySearchComponent } from './quantity-search.component';
...
const meta: Meta<QuantitySearchComponent> = {
  component: QuantitySearchComponent,
  title: 'QuantitySearchComponent',
  decorators: [
    applicationConfig({
      providers: [
        provideAnimations(),
...
type Story = StoryObj<QuantitySearchComponent>;
...
export const Heading: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const searchInput = findInput('quantity');
