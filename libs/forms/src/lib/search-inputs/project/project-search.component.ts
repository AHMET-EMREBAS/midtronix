...
export class ProjectSearchComponent {
  ...
  @Input() inputControl = new FormControl<IProject | null>(null, []);
  @Input() defaultValue?: IProject;
  @Output() changeEvent = new EventEmitter<IProject>();

  search$ = new BehaviorSubject<string>('');

  options$: Observable<IProject[]> = this.service.entities$;
