...
export class UserAddressSearchComponent {
  ...
  @Input() inputControl = new FormControl<IUserAddress | null>(null, []);
  @Input() defaultValue?: IUserAddress;
  @Output() changeEvent = new EventEmitter<IUserAddress>();

  search$ = new BehaviorSubject<string>('');

  options$: Observable<IUserAddress[]> = this.service.entities$;
