...
import { TaxrateSearchComponent } from './taxrate-search.component';
...
const meta: Meta<TaxrateSearchComponent> = {
  component: TaxrateSearchComponent,
  title: 'TaxrateSearchComponent',
  decorators: [
    applicationConfig({
      providers: [
        provideAnimations(),
...
type Story = StoryObj<TaxrateSearchComponent>;
...
export const Heading: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const searchInput = findInput('taxrate');
