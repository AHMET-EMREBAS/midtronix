...
export class MessageSearchComponent {
  ...
  @Input() inputControl = new FormControl<IMessage | null>(null, []);
  @Input() defaultValue?: IMessage;
  @Output() changeEvent = new EventEmitter<IMessage>();

  search$ = new BehaviorSubject<string>('');

  options$: Observable<IMessage[]> = this.service.entities$;
