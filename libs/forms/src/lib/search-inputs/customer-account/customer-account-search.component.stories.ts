...
import { CustomerAccountSearchComponent } from './customer-account-search.component';
...
const meta: Meta<CustomerAccountSearchComponent> = {
  component: CustomerAccountSearchComponent,
  title: 'CustomerAccountSearchComponent',
  decorators: [
    applicationConfig({
      providers: [
        provideAnimations(),
...
type Story = StoryObj<CustomerAccountSearchComponent>;
...
export const Heading: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const searchInput = findInput('customerAccount');
