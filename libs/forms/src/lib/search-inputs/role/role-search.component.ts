...
export class RoleSearchComponent {
  ...
  @Input() inputControl = new FormControl<IRole | null>(null, []);
  @Input() defaultValue?: IRole;
  @Output() changeEvent = new EventEmitter<IRole>();

  search$ = new BehaviorSubject<string>('');

  options$: Observable<IRole[]> = this.service.entities$;
