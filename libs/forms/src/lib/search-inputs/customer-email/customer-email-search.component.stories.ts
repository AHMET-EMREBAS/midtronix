...
import { CustomerEmailSearchComponent } from './customer-email-search.component';
...
const meta: Meta<CustomerEmailSearchComponent> = {
...
type Story = StoryObj<CustomerEmailSearchComponent>;
