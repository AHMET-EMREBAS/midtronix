...
import { CustomerPermissionFormComponent } from './customer-permission-form.component';
...
const meta: Meta<CustomerPermissionFormComponent> = {
  component: CustomerPermissionFormComponent,
  title: 'CustomerPermissionFormComponent',
  decorators: [
    applicationConfig({
      providers: [
        provideAnimations(),
...
export default meta;
type Story = StoryObj<CustomerPermissionFormComponent>;
...
export const Heading: Story = {
  play: async ({ canvasElement }) => {
    ...
    const submitForm = async () => {
      await type(name, 'customer-permission name');
