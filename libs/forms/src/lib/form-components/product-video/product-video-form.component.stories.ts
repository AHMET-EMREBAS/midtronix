...
import { ProductVideoFormComponent } from './product-video-form.component';
...
const meta: Meta<ProductVideoFormComponent> = {
...
export default meta;
type Story = StoryObj<ProductVideoFormComponent>;
